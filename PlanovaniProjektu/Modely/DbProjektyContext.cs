...
public partial class DbProjektyContext : DbContext
{
    ...
    public virtual DbSet<TbProjektyUlohy> TbProjektyUlohies { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<TbAutorizacniTokeny>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("tb_AutorizacniTokeny");

            entity.Property(e => e.DatumPlatnosti).HasColumnType("datetime");
        ...
        modelBuilder.Entity<TbProjektyUlohy>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__tb_Proje__3214EC07812506B3");

            entity.ToTable("tb_ProjektyUlohy");

            entity.HasOne(d => d.ProjektNavigation).WithMany(p => p.TbProjektyUlohies)
                .HasForeignKey(d => d.Projekt)
                .HasConstraintName("FK__tb_Projek__Proje__398D8EEE");

            entity.HasOne(d => d.UlohaNavigation).WithMany(p => p.TbProjektyUlohies)
                .HasForeignKey(d => d.Uloha)
                .HasConstraintName("FK__tb_Projek__Uloha__3A81B327");
        });

        modelBuilder.Entity<TbProjektyUzivatele>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__tb_Proje__3214EC076D88A645");
        ...
        modelBuilder.Entity<TbUzivateleUlohy>(entity =>
        {
            ...
            entity.Property(e => e.DatumDokonceniPrace).HasColumnType("datetime");
